...
<html lang="en">
				...
				<div class="main-content-inner">
				  ...
				  <div class="page-content">
					  <div class="ace-settings-container" id="ace-settings-container">
						 ...
						 {
							 $name=$_REQUEST['name'];
							 $sql = "SELECT * FROM staffsba WHERE staffName LIKE '%".$name."%'";
	...
	<div class="row">
							...
							<div class="tab-content profile-edit-tab-content">
					                ...
					                <form class="form-horizontal" action="functionsSBA.php" method="post" name="upload_excel" enctype="multipart/form-data">
													...
													<tr>
														...
														<td align="center">
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="green" href="javascript:window.open('viewSBA.php?staffID=<?php echo $row['staffID'];?>','mywindowtitle','width=800,height=700')">
