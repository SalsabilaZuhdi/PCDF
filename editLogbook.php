...
@$logbookID = $_POST['logbookID'];
	...
	$select = "call select_logbook4('".@$_REQUEST['logbookID']."')";
...
if(isset($_REQUEST['submit']))
	...
	echo $update = "call update_logbook('".$_REQUEST['logbookID']."','".$_REQUEST['submissiondate']."','".@$_REQUEST['activityDescription']."')";
	...
	if ($essms_update) 
	{
		...
		echo "<script>alert('Logbook Updated')</script>";
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" action="" method="post">
									...
									<h5>&nbsp;&nbsp;&nbsp;Date : <input type="date" name="submissiondate" id="submissiondate" value="<?php echo $row['submissionDate']; ?>" required="" /></h5>
								    <div class="space"></div>
									<div class="col-sm-12">
										<div class="widget-box widget-color-blue">
											...
											<div class="widget-body">
												<div class="widget-main no-padding">
													<textarea name="activityDescription" id="activityDescription" rows="10" cols="85%" required=""><?php echo $row['activityDescription'];?></textarea>
												</div>
