...
include 'conn/dbconnection.php';
 ...
 @$matric_Num = $_POST['matric_Num'];
	...
	$select2 = "call select_finalReport('".$_REQUEST['matric_Num']."')";
...
<?php
	 ...
	 @$updateFinalReportID = $_REQUEST['updateFinalReportID'];
	   @$mark = $_REQUEST['mark'];
	
	if(isset($_REQUEST['submit']))
	{

	  $updateFinalReport ="call update_finalReport('".$statusProject."', '".$mark."','".$content."','".$updateFinalReportID."')";
												...
												<form class="form-horizontal" role="form" method="post" >
													<div id="edit-basic" class="tab-pane in active">
															...
															<div class="form-group">
																...
																<div class="space"></div>
																<input type="hidden" id="updateFinalReportID" name="updateFinalReportID" value="<?php echo $row2['finalreportID']; ?>" size="20" >
																			<h6><b>Total Mark (%)</b></h6>
																	<p><input type="hidden" name="mark" id="mark" size="5" value="<?php echo $row2['mark']; ?>"><input type="text" name="mark" id="mark" size="5" value="<?php 
																	echo $row2['mark']; ?>" disabled>%&nbsp; &nbsp;<a href=	
																"javascript:window.open('assignMarkFinalReport.php?finalreport_ID=<?php 
															    echo $row2['finalreportID'];?>','mywindowtitle','width=1100,height=800')"><input type="button" 
																																																value="Assign Mark"></a></p>
																<div class="space"></div>
