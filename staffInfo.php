				  ...
				  <div class="page-content">
					  <div class="ace-settings-container" id="ace-settings-container">
						 ...
						 if(isset($_REQUEST['search']))
						 {
							...
							$query=mysqli_query($dba,"call select_staffinfo('".$jobGrade1."','".$jobGrade2."','".$jobGrade3."','".$jobGrade4."','".$jobGrade5."')") or die();	
							mysqli_next_result($dba);
								
						 }
						else
						{
							$query=mysqli_query($dba,"call select_staffinfo2") or die();
							mysqli_next_result($dba);
						}
