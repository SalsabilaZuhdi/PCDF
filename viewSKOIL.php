...
@$staffID = $_POST['staffID'];
	...
	if(isset($_REQUEST['submit']))	{
		...
		$MME=$arr2[$_REQUEST['MME']];
			...
			$update = "call update_staffskoil('".$_REQUEST['staffID']."','".$_REQUEST['staffName']."','".$_REQUEST['trade']."','".$_REQUEST['region']."','".$_REQUEST['locationS']."','".$_REQUEST['jobGrade']."','".$_REQUEST['retirementDate']."','".$_REQUEST['statusA']."','".$eLearning."','".$heartMind."','".$DCS."','".$OTS."','".$oralInterview."','".$MME."','".$_REQUEST['remarks']."')";
