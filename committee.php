...
<html lang="en">
 ...
 if(isset($_REQUEST['search']))
 {
		...
		{
			$query=mysqli_query($dba,"call select_searchCommittee('".$department1."','".$department2."','".$department3."' ,'".$department4."')")or die();	
			mysqli_next_result($dba);
		}
		else if ($department1 == '' && $department2=='' && $department3 == '' && $department4=='' )
		{
			$query=mysqli_query($dba,"call select_searchCommittee2('".$position1."','".$position2."' )")or die();
			mysqli_next_result($dba);
			
		}
		else
		{
			$query=mysqli_query($dba,"call select_searchCommittee3('".$department1."', '".$department2."','".$department3."','".$department4."','".$position1."' ,'".$position2."'  )") or die();	
			mysqli_next_result($dba);
		...
		{
			$query=mysqli_query($dba,"call select_searchCommittee4") or die();
			mysqli_next_result($dba);
		}
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<form class="form-horizontal" role="form" method="post" action="committee.php">
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												?>
														...
														<td>
														<p><a href="javascript:window.open('assignCommittee.php?staff_ID=<?php echo $row['staffID'];?>','mywindowtitle','width=800,height=700')"><input type="button" value="Set Position"></a></p>
