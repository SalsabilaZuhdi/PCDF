...
$select = "call select_resetPassL('".$_REQUEST['staff_ID']."')";
	...
	$row = mysqli_fetch_array($essms_select);
		    if(isset($_REQUEST['submit']))
		{
			...
			$update = "call update_changePassword('".$_REQUEST['staff_ID']."', 'abc123')";
											...
											<form class="form-horizontal" action="" method="post">
												<div class="tabbable">
													...
													<div id="edit-basic" class="tab-pane in active">
															...
															<div class="space-4"></div>
															<div class="form-group">
																<label class="col-sm-3 control-label no-padding-right">Lecturer Name : </label>
														...
														<div class="space-4"></div>
															<div class="form-group">
																  <input name="submit" type="submit" id="submit" value="Reset Password" />
															</div>
