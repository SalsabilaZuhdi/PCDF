				  ...
				  <div class="page-content">
					  <div class="ace-settings-container" id="ace-settings-container">
						 ...
						 if(isset($_REQUEST['search']))
							{
								$name=$_REQUEST['name'];
								$sql = "SELECT * FROM staffpma WHERE staffName LIKE '%".$name."%'";
						...
						else
							{
								...
								$query=mysqli_query($dba,"call select_staffpma('".$jobGrade1."','".$jobGrade2."','".$jobGrade3."','".$jobGrade4."','".$jobGrade5."')") or die();	
								mysqli_next_result($dba);
							}

						if(isset($_REQUEST['delete']))
						{
						   mysqli_query($dba,"call delete_all_staffpma") or die();	
						...
						<div class="page-header">
							...
							<div class="tab-content profile-edit-tab-content">
					                ...
					                <form class="form-horizontal" action="functionsPMA.php" method="post" name="upload_excel" enctype="multipart/form-data">
				  				<fieldset>
					...
					<form class="form-horizontal" action="functionsPMA.php" method="post" name="upload_excel" enctype="multipart/form-data">
						<div class="form-group">
							...
							<h6>
							    ...
							    <div class="form-group">
									<div class="col-md-4">
										<button type="submit" id="delete" name="delete" class="btn btn-danger" onclick="return confirm('Do you want to delete all PMA staff ?')">Delete</button>
									</div>
								</div>
