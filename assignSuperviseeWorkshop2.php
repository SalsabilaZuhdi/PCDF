...
<html lang="en">
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="page-header">
							<h1>
								Workshop 2 Supervisee Assignation
							</h1>
						</div><!-- /.page-header -->
...
<?php
		...
		//list student untuk yang dah pilih 
		 $selectSupervisee = "select * from student where lecturerID='".$_REQUEST['staff_ID']."' and typeOfWorkshop='2'";
...
<div id="div3"  style="clear: both;"> 							
	<form method="post" id="searchForm" >
		...
		<tr>
			...
			<?php if($row['department']=='BITI'){ ?>
			<td><input type="checkbox" name="course1" value="BITI" <?php if(isset($_POST['course1'])) echo "checked='checked'"; ?>>BITI </td>
			<td>&nbsp </td>
			<td>&nbsp </td>
			<td>&nbsp </td>
			<?php } else if ($row['department']=='BITC'){?>
			<td><input type="checkbox" name="course1" value="BITC" <?php if(isset($_POST['course1'])) echo "checked='checked'"; ?>>BITC</td>
			<td><input type="checkbox" name="course2" value="BITE" <?php if(isset($_POST['course2'])) echo "checked='checked'"; ?>>BITE</td>
			<td>&nbsp </td>
			<td>&nbsp </td>
			
			<?php } else if ($row['department']=='SE'){?> 
			<td width="109"><input type="checkbox" name="course1" value="BITS" <?php if(isset($_POST['course1'])) echo "checked='checked'"; ?>>BITS</td>
			<td width="111"><input type="checkbox" name="course2" value="BITD" <?php if(isset($_POST['course2'])) echo "checked='checked'"; ?>>BITD</td>
			<td>&nbsp </td>
			<td>&nbsp </td>
			<?php } else if ($row['department']=='MI'){?> 
			<td width="137"><input type="checkbox" name="course1" value="BITM" <?php if(isset($_POST['course1'])) echo "checked='checked'"; ?>>BITM</td>
			<td><input type="checkbox" name="course2" value="BITZ" <?php if(isset($_POST['course2'])) echo "checked='checked'"; ?>>BITZ</td>
			<td>&nbsp </td>
			<td>&nbsp </td>						
			<?php } ?>
			<td width="36">&nbsp;</td>
		...
		<tr>
			...
			<td colspan="5"><input type="hidden" id="staff_ID" name="staff_ID" value="<?php echo $_REQUEST['staff_ID']; ?>" size="5" >
			<input type="hidden" id="department" name="department" value="<?php echo $row['department'];?>" size="10" >
			</td>
		</tr>
		</table>
	</form>
...
<div id="resultForm" > 
	...
	<table  class="table table-striped table-bordered table-hover">
		...
		<?php
			...
			if($course1=='' && $course2=='' && $statusAssign1=='' && $statusAssign2=='')	
			{
		?>
		<tr>
...
$(document).ready(function() {	
	...
	$('#searchForm').submit(function(e){
		...
		$.ajax({
			url: 'search_studentWorkshop2.php',
			type: 'POST',
