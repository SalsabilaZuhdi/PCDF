...
<html lang="en">
 ...
 if(isset($_REQUEST['search']))
 {
		...
		if(!empty($searchByName) && $position1 == '' && $position2=='' && $department1 == '' && $department2=='' && $department3 == '' && $department4=='' )
		{
		...
		else if($position1 == '' && $position2=='' )
		{
			$query=mysqli_query($dba,"select * from lecturer 
										...
										left join allocation_student on lecturer.staffID = allocation_student.staffID 
										where
										(department = '".$department1."' OR department = '".$department2."' OR department = '".$department3."' OR department = '".$department4."' ) AND 
										(lecturer.positionID = '2' OR lecturer.positionID = '3' ) AND  lecturer.lecturerName LIKE '%".$searchByName."%'
										GROUP BY lecturer.staffID ORDER BY positionName ASC,lecturer.department DESC, lecturer.staffID ASC")or die();	
			mysqli_next_result($dba);
...
?> 
	<div class="page-header">
							<h1>
								Workshop 1 Supervisor Assignation
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="row">
								<div class="col-sm-5">
									...
									<form class="form-horizontal" role="form" method="post" action="supervisor1.php">
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-flat">
												<h4 class="widget-title lighter">
													...
													Student Allocation	<span class="label label-danger arrowed">Workshop 1</span>
												</h4>
											...
											<div class="widget-body">
												...
												<?php
											$selectTotalStudent = "select count(*) as TotalStudent from student where typeOfWorkshop='1'  ";
											...
											$selectTotalStudentNotAssigned = "select count(*) as TotalStudentNotAssigned from student where typeOfWorkshop='1' AND statusAssign='Not Assigned'";
											$essms_selectTotalStudentNotAssigned =mysqli_query($dba,$selectTotalStudentNotAssigned) or die (mysqli_error());
											mysqli_next_result($dba);
											$rowTotalStudentNotAssigned=mysqli_fetch_assoc($essms_selectTotalStudentNotAssigned);
											 
											$selectTotalLecturer = "select count(*) as TotalLecturer from lecturer ";
														...
														<thead class="thin-border-bottom">
															...
															<tr>
																...
																<th>
																	...
																	$updateallocation = "update allocation_student set allocationWorkshop1='".$roundallocation."'";
																...
																<tr>
																<th>
																	<i class="ace-icon fa fa-caret-right blue"></i>Total Student (Not Assigned)
																</th>

																<th>
																<?php echo @$rowTotalStudentNotAssigned[TotalStudentNotAssigned]; ?>
																</th>
															</tr>
														</thead>
								...
								<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												?>
														...
														<td align="center"><?php echo $row['totalSuperviseeWorkshop1'];?></td>
														<td align="center"><?php echo $row['allocationWorkshop1'];?></td>
															<td>
														<p><a href="javascript:window.open('assignSuperviseeWorkshop1.php?staff_ID=<?php echo $row['staffID'];?>','mywindowtitle','width=1400,height=800')"><input type="button" value="Assign Supervisee"></a></p>
