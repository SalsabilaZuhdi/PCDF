...
<html lang="en">
	...
	<div class="main-container ace-save-state" id="main-container">
		...
		<div class="page-header">
							<h1>
								Assign Due Submission (Proposal)
							</h1>
						</div><!-- /.page-header -->
                        		<div class="tab-content profile-edit-tab-content">
									...
									<label class="control-label col-xs-12 col-sm-3 no-padding-right">Date to be submit : </label>
										...
										<div class="col-xs-12 col-sm-9">
											  ...
											  <input name="assign" type="submit" id="assign" value="Set Submisson" />
										</div>
									...
									<div class="space"></div>
											<?php
											 $select = "call select_reportSubmissionP";
											?>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												<?php
												$essms_select =mysqli_query($dba,$select) or die (mysql_error());
												mysqli_next_result($dba);
												$count=1;
