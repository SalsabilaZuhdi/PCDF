...
$id = $_SESSION['id'];
 ...
 if (@$_SESSION['password'] == "")
 {
	...
	echo'<META HTTP-EQUIV="Refresh" CONTENT="0.001; URL=index.php">';
		...
		$select = "call select_lecturerID_appointment('".$id."')";
		...
		$sql = "call select_appointmentSupervisor('".$id."')";
...
<div class="main-content">
   ...
   <div class="container">
	...
	<div class="modal-content">
			  ...
			  <div class="modal-body">
				 <div class="form-group">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="title" class="form-control" id="title" placeholder="Agenda">
					</div>
				  </div>
				  <div class="form-group">
		...
		<form class="form-horizontal" method="POST" action="approveappointment.php">
			  ...
			  <div class="modal-body">
				 <div class="form-group">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
					<label for="date_created" class="col-sm-2 control-label">Created</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label for="end" class="col-sm-2 control-label">Status</label>
					<div class="col-sm-10">
					 <select id="statusappointment" name="statusappointment" required="" >
						<option value=""></option>
		...
		<?php
				  $selectAppointment = "call select_appointSupervisor('".$id."')";
				  
				  $selectCount = "call select_count1('".$id."')";
		?>
		<table id="dynamic-table" class="table table-striped table-bordered table-hover">
			...
			<tbody>
		<?php
			$essms_selectAppointment =mysqli_query($dba,$selectAppointment) or die (mysqli_error());
			mysqli_next_result($dba);
		...
		?>
			...
			<tr>
				...
				<td><?php echo $rowAppointment['studentName'];?></td>
		...
		$('#calendar').fullCalendar({
			...
			eventRender: function(event, element) {
				element.bind('dblclick', function() {
					...
					$('#ModalEdit #date_created').val(event.date_created);
			...
			?>
				{
					...
					date_created: '<?php echo $event['date_created']; ?>',
