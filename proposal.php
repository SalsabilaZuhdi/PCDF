...
$id = $_SESSION['id'];
 if (@$_SESSION['password'] == "")
 {
	...
	$select2 = "call select_proposal('".$id."')";
								...
								<!-- PAGE CONTENT BEGINS -->
									...
									<div id="user-profile-3" class="user-profile row">
										<div class="col-sm-offset-1 col-sm-10">
											...
											<form class="form-horizontal" action="uploadProposal.php" method="post" >
									...
									<div class="space"></div>
											<?php
											 $selectProposal = "call select_proposal('".$id."')";
											?>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												?>
													<tr>
														...
														<td><?php echo $rowProposal['remarks'];?></td>
														<td><?php echo $rowProposal['statusSubmission'];?></td>
														<td><?php echo $rowProposal['statusProject'];?></td>
														<td><p>	<i class="menu-icon fa fa-upload"></i>&nbsp;<a href="Documents/Proposal/<?php echo $rowProposal['sourceP']; ?>"  ><?php echo $rowProposal['sourceP']; ?></a></p></td><?php if($rowProposal['statusProject']=='Pending Approval'){ ?>
														<td align="center" onclick = "return confirm('Are you sure ?');">
														<div class="hidden-sm hidden-xs action-buttons">
														<?php echo "<a class='red' href=deleteProposal.php?deleteID=".$rowProposal['proposalID'].">"?>
